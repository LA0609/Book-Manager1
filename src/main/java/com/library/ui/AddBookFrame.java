...
public class AddBookFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel10.setText("图书ID：");

        jLabel1.setText("  状态：");

        jComboBox1.setBackground(new java.awt.Color(204, 204, 204));
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "可借阅", "已借阅" }));
    ...
    private void jToggleButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jToggleButton1ActionPerformed
        ...
        String status = (String) jComboBox1.getSelectedItem(); // 状态

        // 空值校验（图书ID和库存可以为空，其他必填）
        if (name.isEmpty() || author.isEmpty() || publisher.isEmpty()) {
            JOptionPane.showMessageDialog(this, "书名、作者、出版社不能为空！", "提示", JOptionPane.WARNING_MESSAGE);
            return;
        }
